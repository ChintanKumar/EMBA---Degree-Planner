...
/* Keep UTD bars aligned with the rest of the page */
.utd-header,
.utd-subheader {
    width: 100% !important;
...
/* Make widget use full available width */
iframe {
    width: 100% !important;
}
/* End of Compact CSS */
...
st.markdown(
    ...
    <div class="info-banner">
      ...
      Click <em>Generate plan</em>, to create a recommended term-by-term schedule
      based on OBCC course offerings and prerequisites.
    </div>
    """,
    unsafe_allow_html=True,
)
...
if df is not None:
    ...
    header_txt = (
        ...
        f"Include summer: {'Yes' if meta.get('include_summer', True) else 'No'}"
        f"{breaks_label}"
    )
...
st.markdown(
    """
    <div class="info-banner">
      <strong>Upload your generated degree plan PDF to ask questions or explore possible adjustments.</strong>
      The assistant can review the uploaded plan and suggest changes, but it does not regenerate or export a new PDF.
    </div>
    """,
    unsafe_allow_html=True,
)
...
<script defer
  src="https://www.gstatic.com/ces-console/fast/chat-messenger/prod/v1.15/chat-messenger.js">
</script>
<link rel="stylesheet" href="https://www.gstatic.com/ces-console/fast/chat-messenger/prod/v1.15/themes/chat-messenger-default.css">
<link rel="stylesheet" href="https://www.gstatic.com/ces-console/fast/chat-messenger/prod/v1.15/themes/chat-messenger-layout.css">
    ...
    window.addEventListener("chat-messenger-loaded", () => {
      chatSdk.registerContext(
        chatSdk.prebuilts.ces.createContext({
          deploymentName: "projects/683181929127/locations/us/apps/c6b3bdad-30d7-4757-88ad-1fc7f6a57d73/deployments/9d8f2fbf-65f7-4bdf-b068-5bb0a21f783c",
          tokenBroker: {
...
>
  <chat-messenger-container
    chat-title="Refinement Assistant"
